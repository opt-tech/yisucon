...
@Singleton
class IsutomoController @Inject()(cc: ControllerComponents, friendRepository: FriendsRepository)
  ...
  def initializer() = {
    val builder = new ProcessBuilder("mysql", "-u", "root", "-D", "isutomo", "-h", "127.0.0.1")
